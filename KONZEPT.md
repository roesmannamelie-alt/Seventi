...
4. **Kategorienband**, die fünf Kategorien laufen als endloses Band durch, ohne Überschrift und ohne eigene Fläche: der Ton entspricht den Abschnitten darüber und darunter, damit das Band nicht als eigener Kasten liest, sondern als ruhige Zäsur zwischen Argumenten und Profil. Zwei gleiche Bahnen laufen nahtlos, ein Skript füllt sie auf, bis eine allein breiter ist als das Fenster. Beim Hover hält das Band an und die Icons zeichnen sich nach. Die Regionen stehen bereits im Hero-Kicker, deshalb wiederholt der Abschnitt sie nicht.
